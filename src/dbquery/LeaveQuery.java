...
public class LeaveQuery {
    ...
    public static int getVLCredits(int empId) { return getCredits(empId, "vl_credits"); }
    public static int getSLCredits(int empId) { return getCredits(empId, "sl_credits"); }
